...
public class Film_Encanto extends JPanel {
    ...
    public Film_Encanto() {
        ...
        lbl_Icon_Film.setBounds(0, 11, 120, 178);
    ...
    private void loadFilmData() {
        try {
            String query = "SELECT Title, Genre, Duration, Rating FROM Movies WHERE Title = 'Encanto'";
            ...
            if (rs.next()) {
                ...
                String imagePath = "/Image_Film_For_Information_Film/FilmEncanto.png";
    ...
    private void loadSeatData() {
        ...
        try {
            String query = "SELECT ChairName FROM RoomManagement.Room_A2";
            Connection connection = DatabaseHelper.getConnection();
            PreparedStatement ps = connection.prepareStatement(query);
            ResultSet rs = ps.executeQuery();
