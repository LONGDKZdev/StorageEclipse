...
public class Film_Pleasure extends JPanel {
    private JTextArea filmInfo;

    public Film_Pleasure() {
        setLayout(new BorderLayout());

        JLabel lblTitle = new JLabel("Pleasure Information", SwingConstants.CENTER);
    ...
    private void loadFilmData() {
        String movieInfo = DatabaseHelper.getMovieInformation("Pleasure");
