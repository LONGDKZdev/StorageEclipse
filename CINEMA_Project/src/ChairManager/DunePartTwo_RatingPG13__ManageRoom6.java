...
public class DunePartTwo_RatingPG13__ManageRoom6 extends ChairBase {

    private static final long serialVersionUID = 1L;

    public DunePartTwo_RatingPG13__ManageRoom6() {
        super(20);
        setBorder(BorderFactory.createTitledBorder("Dune: Part Two - Room C2"));
        loadChairDataFromDatabase();
    }

    private void loadChairDataFromDatabase() {
        try (Connection conn = SQLServerConnection.getConnection()) {
            String sql = "SELECT ChairName, UserID, Username FROM RoomManagement.Room_C2";
