...
public class TheMarvels_RatingPG13__ManageRoom5 extends ChairBase {

    private static final long serialVersionUID = 1L;

    public TheMarvels_RatingPG13__ManageRoom5() {
        super(20);
        setBorder(BorderFactory.createTitledBorder("The Marvels - Room C1"));
        loadChairDataFromDatabase();
    }

    private void loadChairDataFromDatabase() {
        try (Connection conn = SQLServerConnection.getConnection()) {
            String sql = "SELECT ChairName, UserID, Username FROM RoomManagement.Room_C1";
