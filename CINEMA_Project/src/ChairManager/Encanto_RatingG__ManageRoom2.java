...
public class Encanto_RatingG__ManageRoom2 extends ChairBase {

    private static final long serialVersionUID = 1L;

    public Encanto_RatingG__ManageRoom2() {
        super(20);
        setBorder(BorderFactory.createTitledBorder("Encanto - Room A2"));
        loadChairDataFromDatabase();
    }

    private void loadChairDataFromDatabase() {
        try (Connection conn = SQLServerConnection.getConnection()) {
            String sql = "SELECT ChairName, UserID, Username FROM RoomManagement.Room_A2";
