...
public class JohnWick4_RatingR__ManageRoom8 extends ChairBase {

    private static final long serialVersionUID = 1L;

    public JohnWick4_RatingR__ManageRoom8() {
        super(20);
        setBorder(BorderFactory.createTitledBorder("John Wick: Chapter 4 - Room D2"));
        loadChairDataFromDatabase();
    }

    private void loadChairDataFromDatabase() {
        try (Connection conn = SQLServerConnection.getConnection()) {
            String sql = "SELECT ChairName, UserID, Username FROM RoomManagement.Room_D2";
