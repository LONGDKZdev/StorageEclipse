...
public class Pleasure_RatingNC17__ManageRoom10 extends ChairBase {

    private static final long serialVersionUID = 1L;

    public Pleasure_RatingNC17__ManageRoom10() {
        super(20);
        setBorder(BorderFactory.createTitledBorder("Pleasure - Room E2"));
        loadChairDataFromDatabase();
    }

    private void loadChairDataFromDatabase() {
        try (Connection conn = SQLServerConnection.getConnection()) {
            String sql = "SELECT ChairName, UserID, Username FROM RoomManagement.Room_E2";
