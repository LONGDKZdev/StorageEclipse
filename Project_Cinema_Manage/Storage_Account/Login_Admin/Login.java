...
public class Login extends JFrame {
	...
	public Login() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Login.class.getResource("/Login_Admin/Log icon(Programing).png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/Login status.png")));
...
//                    dispose();             
		...
		btnNewButton.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/Login button.png")));
		btnNewButton.setBounds(691, 464, 304, 112);
		contentPane.add(btnNewButton);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setBackground(new Color(255, 255, 255));
		lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/My photo.jpg")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/napkin-selection.png")));
		lblNewLabel_1.setBounds(90, 111, 200, 208);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/Red backgroun.png")));
		lblNewLabel_2.setBackground(new Color(255, 255, 255));
		lblNewLabel_2.setBounds(0, 10, 407, 673);
		...
		BackGround.setIcon(new ImageIcon(Login.class.getResource("/Login_Admin/CinemaBackgroun.png")));
